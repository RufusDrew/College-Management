...
<?php  
 	if (isset($_POST['btn_save'])) {
		...
		$permanent_address=$_POST["permanent_address"];
 		...
 		$password=  substr(str_shuffle(md5($requesttime)), 0, 8);
...
// *****************************************Images upload code end here********************************************************** 
		$validateAcc ="SELECT * FROM login WHERE user_id = '$email'" ;
		if(mysqli_num_rows(mysqli_query($con,$validateAcc)) == 0){
 		...
 		if ($run) {
			...
			$teacher_id = mysqli_insert_id($con);
			 ...
			 if ($run2) {
				...
				// Email Required to intimidate teacher about  enrollment
				// ----------------------
				$applicantName = $first_name.' '.$middle_name.' '.$last_name;
				$mail = new PHPMailer(true);

				$usermailer ='admin@amandeepbettiah.in';
				$subject = 'Welcome To Abhimanyu Super-40';
			...
			try {
				...
				",<br>Thank you for your interest and welcome to our team Abhimanyu Super-40. We want to inform you that can use our portal.<br>".
				"Your login credentials will be shared shortly<br><br>".
				"Thanks & Regards<br>".
				"Abhimanyu Super-40";
				
				
				$mail->AltBody =  "Dear ".$applicantName.
				",\n Thank you for your interest and welcome to our team Abhimanyu Super-40. We want to inform you that you can you our portal. \n".
				"Your login credentials will be shared shared shortly \n \n".
				"Thanks & Regards \n".
				"Abhimanyu Super-40";
				...
				// ---------------------------------
				 ...
				 $error_message = "Teacher Added But Operation Failed, Please Delete Teacher ID ".$teacher_id.'. Try Again.';
			 }
 		}
		 else{
			$error_message = "Teacher Add Operation Failed, Try Again.";
			...
			$error_message = "Email Already registered with another teacher account. Use New Email";
 		}
...
<?php  
	if (isset($_POST['btn_save2'])) {
		...
		$validateTeacherId = "SELECT teacher_id FROM `teacher_info` WHERE teacher_id = 	$teacher_id";
		if(mysqli_num_rows(mysqli_query($con,$validateTeacherId)) > 0){
		...
		if ($run3) {
			 ...
			 $error_message = "Subject Assignement Failed";
	
 		}
	}
	else{
		$error_message = "Invalid Teacher Id: ".$teacher_id;
	}
									...
									<div class="modal-body">
										<form action="teacher.php" method="post" enctype="multipart/form-data">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="text" name="email" class="form-control" required="" placeholder="Enter Email" required>
													</div>
												</div>
												<div class="col-md-4">
													<div class="formp">
											...
											<div class="row">
												...
												<div class="col-md-4">
													<div class="formp">
														...
														<input type="text" name="cnic" class="form-control" placeholder="Aadhaar No" required>
													</div>
												</div>
											</div>
											<div class="row">
											...
											<div class="row">
												<div class="col-md-4">
													<div class="form-group">
														<label for="exampleInputEmail1">MA completion Date: </label>
