		...
		<div class="container  mt-1 border border-secondary mb-1">
			<div class="row text-white bg-primary pt-5">
				<div class="col-md-4">
					...
					<img class="ml-5 mb-5" height='270px' width='250px' src=<?php echo "images/".rawurlencode($profile_image);  ?> >
				</div>
				<div class="col-md-8">
					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<h5>Aadhaar No:</h5> <?php echo $row['cnic']  ?><br><br>
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>Matric completion Date:</h5> <?php echo $row['matric_complition_date']  ?></div>
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>High School completion Date:</h5> <?php echo $row['fa_complition_date']  ?></div>
				<div class="col-md-4"><h5>High School Awarded Date:</h5> <?php echo $row['fa_awarded_date']  ?></div>
				<div class="col-md-4"><h5>High School Certificate:</h5> <?php echo $row['fa_certificate']  ?></div>
			</div>
			<div class="row pt-3">
				<div class="col-md-4"><h5>BA completion Date:</h5> <?php echo $row['ba_complition_date']  ?></div>
			...
			<div class="row pt-3">
				<div class="col-md-4"><h5>MA completion Date:</h5> <?php echo $row['ma_complition_date']  ?></div>
