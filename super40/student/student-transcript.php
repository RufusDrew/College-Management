...
<?php include "../common/common-header.php"?>
    <div class="container mt-4">
        <div class="text-danger text-center m-auto">
            <img src="../Admin/images/mjk_logo.jpeg" alt="" width="100" height="100">
            <h4 class="text-dark mt-3">ABHIMANYU SUPER-40</h4>
            <h4 class="text-dark">SCHOOL OF Technology & DESIGN</h4>
        </div>
    </div>
                        ...
                        <div class="mt-2">
                            <table class="w-100 table-elements table-six-tr"cellpadding="2">
                                ...
                                <tr>
                                    ...
                                    <th colspan="2"><?php 
                                     if( $total_semester_ch > 0){
                                        echo  round(($all_semester_quality_points/$total_semester_ch), 2); 
                                    }
                                    else{
                                        echo  round(0, 2); }
                                    ?></th>
